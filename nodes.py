...
class MuseTalkCupAudio:
    ...
    def run(self,audio_path,start,end):
        ...
        t=int(time.time())
        sound.export(f'{folder_paths.get_output_directory()}/{t}.wav', format="wav")
        return (f'{folder_paths.get_output_directory()}/{t}.wav',)
...
class MuseTalkRun:
    ...
    def run(self, video_path,audio_path,bbox_shift,batch_size, musetalk):
        ...
        parser.add_argument("--result_dir", default=folder_paths.get_output_directory(), help="path to output")
